        ...
        >
          ...
          <div className="card-container">
            <div className="card-border">
              ...
              {guestName && (
                <div style={{ fontFamily: '"Alex Brush", cursive', fontSize: '42px', color: '#8f6844', marginTop: '-15px', marginBottom: '5px', zIndex: 2, textAlign: 'center', fontWeight: 500, textShadow: '0 1px 2px rgba(201,169,110,0.3)' }}>
                  For {guestName}
                </div>
              )}
              ...
              <div className="text-details">
                ...
                <span className="text-date">Monday 17 August 2026 At 9:30 AM</span>
                <span className="text-church">Cumulus ballroom</span><br />
